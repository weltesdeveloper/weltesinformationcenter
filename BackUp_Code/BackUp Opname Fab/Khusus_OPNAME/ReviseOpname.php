...
<div id="wrap">
  ...
  <div class="container-fluid">
    <div class="page-header">
      ...
      <font color="#0033CC"><b>REVISE OPNAME</b></font></h1>
    </div>
...
<!--        <div class="form-group">
        ...
        <div class="col-xs-4">
            <input type="date" class="form-control" id="edit-datex" >
        </div>-->
    <!--</div>-->
    </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="exampleModalLabel">REVISE OPNAME</h4>
            </div>
...
//           $('#edit-datex').datepicker();
        ...
        $('#jobDropdownMonitor').on('change', $(this), function () {
            ...
            $.ajax({
                type: 'POST',
                url: "ReviseOpname/showBuildingDropdownMonitor.php",
