...
function getHeadmark(projectName) {		
		var strURL="findHeadmark.php?project="+projectName;
		var req = getXMLHTTP();
...
function getElements(projectName,hmVal) {		
		var strURL="showUpdateableElements.php?project="+projectName+"&headmarkValue="+hmVal;
		var req = getXMLHTTP();
