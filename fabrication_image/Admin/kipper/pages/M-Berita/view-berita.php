		...
		<section id="widget-grid" class="">
			...
			<div id="list">
				...
				<div class="jarviswidget jarviswidget-color-greenLight" data-widget-editbutton="false">
					...
					<header>
						<h2>List <strong>Berita</strong></h2>						
					</header>
			...
			<div id="form" style="display:none" >
				...
				<div class="jarviswidget jarviswidget-color-teal" data-widget-editbutton="false">
					...
					<header>
						<h2>Form <strong>Berita</strong> </h2>	
							...
							<form id="formInput" class="form-horizontal iconAfterControl" >
								...
								<fieldset>
									<div class="form-group">
										<label class="col-xs-1 col-lg-2 control-label">Judul Berita</label>
								...
								<fieldset>
									<div class="form-group">
										<label class="col-xs-1 col-lg-2 control-label">Isi Berita</label>
										<div class="col-xs-9 col-lg-10 inputGroupContainer">
											<div class="input-group">
												<span class="input-group-addon">$</span>
...
<script src="pages/M-Berita/script-berita.js" type="text/javascript"></script>
