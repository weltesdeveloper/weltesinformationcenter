		...
		<section id="widget-grid" class="">			
			<div id="list">			
				...
				<div class="jarviswidget jarviswidget-color-greenLight" data-widget-editbutton="false">
					...
					<header>
						<h2>List <strong>Kategori Product</strong></h2>						
					</header>
			...
			<div id="form" style="display:none" >
				...
				<div class="jarviswidget jarviswidget-color-teal" data-widget-editbutton="false">
					...
					<header>
						<h2>Form <strong>Kategori Product</strong> </h2>	
					</header>
							...
							<form id="formInput" class="form-horizontal iconAfterControl" >
								...
								<fieldset>
									<div class="form-group">
										<label class="col-xs-1 col-lg-2 control-label">Nama Kategori Product</label>
...
<script src="pages/M-Kat-Product/script-kat-product.js" type="text/javascript"></script>
