...
function DailyFabrication() {
    ...
    $header = '<table>'
            . '<tr><th style="text-align:center;" colspan=17><b><u>LAPORAN PROGRESS BY ASSEMBLY W15050 (STRUCTURE PROJECT SEMEN REMBANG) TANGGAL ' . $date . '</u></b></th></tr>'
    ...
    $projectSql = "SELECT DISTINCT PROJECT_NAME_OLD,CLIENT_INIT,PROJECT_NAME_NEW FROM VW_PROJ_INFO "
            . "WHERE PROJECT_TYP = 'STRUCTURE' AND PROJECT_NO = 'W15050' ORDER BY CLIENT_INIT,PROJECT_NAME_NEW";
...
//    exit();
    ...
    $m = mail($recepient, 'LAPORAN PROGRESS BY ASSEMBLY W15050 (PROJECT SEMEN REMBANG)', $qwe, $mailheaders);
    $IDEMAIL = "email-" . date("d/m/Y");
    if ($m) {
        $insertEmailSql = "INSERT INTO EMAIL_NOTIFICATION (ID_EMAIL, RECEIVER, SENT_DATE, STATUS, EMAIL_TYPE) VALUES('$IDEMAIL', '$recepient', SYSDATE, 'SUCCESS', 'W15050')";
