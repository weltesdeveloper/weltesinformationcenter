    ...
    <body>
        <div class="panel panel-default">
            ...
            if (isset($_POST['submitBTN'])) {
                ...
                $updateSubcontStatusSql = "UPDATE MASTER_DRAWING SET DISTRIBUTION_COUNT = DISTRIBUTION_COUNT + 1 WHERE HEAD_MARK = :HEADMARK  "
                ...
                //SELECT HM 
                $projectSql = "SELECT WEIGHT,SURFACE,DISTRIBUTION_COUNT,REV FROM MASTER_DRAWING WHERE PROJECT_NAME='$projName' AND HEAD_MARK = '$headMarkSelect' AND COMP_TYPE = '$compName' AND DWG_STATUS='ACTIVE'";
                ...
                $modSql = "INSERT INTO MASTER_DRAWING_ASSIGNED (ASSIGNED_QTY, SUBCONT_ID, REVISION_NO, ASSIGNMENT_DATE, "
                        ...
                        . ":HEADMARK, (TO_DATE('$ASSIGNDate','MM/DD/YYYY hh24:mi:ss') + :DUEDATE), '$username')";
                ...
                $checkerSql = "SELECT MD.TOTAL_QTY AS TOTALQTY, MDA.SUMASSIGNEDQTY 
                                    ...
                                    WHERE MD.HEAD_MARK = :HEADMARK AND MD.PROJECT_NAME = :PROJNAME AND MD.DWG_STATUS='ACTIVE'";
