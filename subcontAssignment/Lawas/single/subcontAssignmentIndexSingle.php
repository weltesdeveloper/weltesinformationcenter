            ...
            if (isset($_POST['Btnsubmit'])){  
                ...
                if ($hms){
                    foreach ($hms as $value){
                        ...
                        $updateSubcontStatusSql = "UPDATE MASTER_DRAWING SET SUBCONT_STATUS = 'ASSIGNED',DISTRIBUTION_COUNT = DISTRIBUTION_COUNT + 1 WHERE HEAD_MARK = :HEADMARK AND PROJECT_NAME = :PROJNAME AND COMP_TYPE = :COMPONENT AND DWG_STATUS='ACTIVE'";

                        //SELECT HM 
                        $projectSql = "SELECT WEIGHT,SURFACE,TOTAL_QTY,REV FROM MASTER_DRAWING WHERE PROJECT_NAME='$projName' AND HEAD_MARK = '$value' AND COMP_TYPE = '$compName' AND DWG_STATUS='ACTIVE'";
                        ...
                        $modSql = "INSERT INTO MASTER_DRAWING_ASSIGNED (ASSIGNED_QTY, SUBCONT_ID, REVISION_NO, ASSIGNMENT_DATE, "
                                ...
                                . "VALUES ('$TOTAL_QTY', :SUBCONTID, $REV, TO_DATE('$ASSIGNDate','MM/DD/YYYY hh24:mi:ss'), "
                                . " :PROJNAME, 1, :HEADMARK, (TO_DATE('$ASSIGNDate','MM/DD/YYYY hh24:mi:ss') + :DUEDATE), '$username')";
                        ...
                        $insertIntoFabSql = "INSERT INTO FABRICATION (HEAD_MARK, ID, ENTRY_DATE, MARKING, CUTTING, ASSEMBLY, WELDING, "
                                ...
                                . "VALUES (:HEADMARK, 1, TO_DATE(:DWGDOWN,'MM/DD/YYYY hh24:mi:ss'), 0,0,0,0,0,0, :PROJNAME, 'NOTCOMPLETE', "
                                . "'$TOTAL_QTY', "
                                . "SYSDATE)";                    
