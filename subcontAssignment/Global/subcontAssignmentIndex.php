            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" id="attributeForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onSubmit='return doSubmit()' data-bv-message="This value is not valid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
                            $projectNameSql = "SELECT DISTINCT PROJECT_NO, PROJECT_NAME, PROJECT_NAME_NEW FROM VW_DRAWING_INFO WHERE TOTAL_QTY <> ASSIGNED_QTY ORDER BY PROJECT_NO,PROJECT_NAME_NEW";
                            $projectNameParse = oci_parse($conn, $projectNameSql);
                            oci_execute($projectNameParse);

                            echo '<select class="form-control" name="projName" id="projName" data-live-search="true">';
                    ...
                    <div id="ValInput" style="display:none;">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                echo '<select class="form-control" name="subcontAssign" id="subcontAssign" data-live-search=true data-bv-notempty="true" data-bv-notempty-message="SUBCONTRACTOR is required and cannot be empty">' . '<br>';
                                echo '<option value="" class="hide">' . "" . '</OPTION>';
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-sm-2 control-label">QC. DIMENSI</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-sm-2 control-label">QC. VISUAL</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label for="DUEDate" class="col-sm-2 control-label">DUE DATE FABRICATION</label>
                            <div class="col-sm-2">
            ...
            if (isset($_POST['submitBTN'])) {
                ...
                for ($i = 0; $i <= $jmlSelectHM; $i++) {
                    ...
                    if (isset($_POST["HM$i"])) {
                        ...
                        //SELECT HM 
                        $projectSql = "SELECT WEIGHT,SURFACE,DISTRIBUTION_COUNT,REV,COMP_TYPE FROM MASTER_DRAWING "
                                . " WHERE PROJECT_NAME='$projName' AND HEAD_MARK = '$headMarkSelect' AND DWG_STATUS='ACTIVE'";
...
//                        oci_bind_by_name($insertIntoFabParse, ":SUBCONTID", $subcontId);
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#projName,#subcontAssign,#spvFab,#QCInsp').selectpicker();
