...
$projName = urldecode($_GET['projName']);
...
$SPV_SQL = "SELECT DISTINCT (SPV_FAB) FROM MASTER_DRAWING_ASSIGNED "
        . "WHERE PROJECT_NAME = 'SMSCENTRIFUGAL' "
        . "AND SUBCONT_ID = '$subcont' "
        . "AND TO_DATE (TO_CHAR (ASSIGNMENT_DATE, 'MM/DD/YYYYHH24:MI:SS'), 'MM/DD/YYYYHH24:MI:SS') "
        . "BETWEEN TO_DATE ('$startdate','MM/DD/YYYY HH24:MI:SS') "
        . "AND TO_DATE ('$enddate', 'MM/DD/YYYY HH24:MI:SS')";
// echo "$SPV_SQL<hr>";
$SPV = SingleQryFld($SPV_SQL, $conn);

$QC_INSP_SQL = "SELECT DISTINCT (QC_INSP) FROM MASTER_DRAWING_ASSIGNED "
        . "WHERE PROJECT_NAME = 'SMSCENTRIFUGAL' "
        . "AND SUBCONT_ID = '$subcont' "
        . "AND TO_DATE (TO_CHAR (ASSIGNMENT_DATE, 'MM/DD/YYYY HH24:MI:SS'), 'MM/DD/YYYY HH24:MI:SS') "
        . "BETWEEN TO_DATE ('$startdate','MM/DD/YYYY HH24:MI:SS') "
        . "AND TO_DATE ('$enddate', 'MM/DD/YYYY HH24:MI:SS')";
// echo "$QC_INSP_SQL<hr>";
            ...
            <table align="center" class="table-condensed table-bordered" cellspacing="0" cellpadding="0">
                <thead>
                    <tr class="hder">
                        ...
                        <th colspan="9"><h5><b>LAPORAN HARIAN FABRIKASI <?php
                                    if ($_GET['type'] == "FABR_REV") {
                                        echo "REVISI";
                                    }
                                    ?></b></h5></th>
                        <th colspan="10"><b>TANGGAL DRAWING TURUN</b><br><h5><b><?php echo $dt1->format('d-F-Y') ?></b></h5></th>
                    </tr>
                    <tr>
                    ...
                    <tr class="hder">
                        <th rowspan="3">No</th>
                        <th rowspan="3" class="print-hm">Head Mark</th>
                ...
                <?php
                $projectNameSql = "SELECT MD.PROFILE, "
                        . "MD.LENGTH,MD.WEIGHT,"
                        . "MD.COMP_TYPE, "
                        . "MDA.* "
                        . "FROM MASTER_DRAWING_ASSIGNED MDA "
                        . "INNER JOIN MASTER_DRAWING MD "
                        . "ON MD.HEAD_MARK=MDA.HEAD_MARK "
                        . "AND MD.PROJECT_NAME=MDA.PROJECT_NAME "
                        . "WHERE MDA.PROJECT_NAME='$projName' "
                        . "AND MDA.SUBCONT_ID='$subcont' AND "
                        . "TO_DATE (TO_CHAR (ASSIGNMENT_DATE, 'MM/DD/YYYY HH24:MI:SS'), 'MM/DD/YYYY HH24:MI:SS') "
                        . "BETWEEN TO_DATE('$startdate', 'MM/DD/YYYY HH24:MI:SS') AND "
                        . "TO_DATE ('$enddate', 'MM/DD/YYYY HH24:MI:SS') "
                        . "AND MD.DWG_STATUS='ACTIVE'"
                        . "ORDER BY MD.COMP_TYPE , TO_NUMBER(REGEXP_REPLACE(MDA.HEAD_MARK,'[^[:digit:]]', null))";
//                 echo "$projectNameSql";// -- $selectedDate1 --$selectedDate2";
                ...
                <tbody>
                    ...
                    while ($row = oci_fetch_array($projectNameParse)) {
                        ...
                        <tr>
                            <td><?php echo $i ?></td>                                        
                            <td class="print-hm"><?php echo $row['HEAD_MARK']; ?></td> 
            ...
            <table align="center" class="table-condensed table-bordered" cellspacing="0" cellpadding="0">
                ...
                $projectNameSql = "SELECT MD.PROFILE, MD.LENGTH,MD.SURFACE,MD.COMP_TYPE, MDA.* 
                    ...
                    WHERE MDA.PROJECT_NAME='$projName' AND MDA.SUBCONT_ID='$subcont' AND "
                        ...
                        . " ORDER BY MD.COMP_TYPE , TO_NUMBER(REGEXP_REPLACE(MDA.HEAD_MARK,'[^[:digit:]]', null))";
                // echo "$projectNameSql -- $selectedDate1 --$selectedDate2";TO_CHAR(ASSIGNMENT_DATE,'MM/DD/YYYY')=TO_CHAR(TO_DATE('$date1','MM/DD/YYYY'),'MM/DD/YYYY')
                $projectNameParse = oci_parse($conn, $projectNameSql);
                oci_execute($projectNameParse);
                ?>
                <tbody>
