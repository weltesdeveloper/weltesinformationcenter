...
switch ($_POST['action']) {
    case "change_tanggal":
        ...
        $tanggalSql = "SELECT DISTINCT PROJECT_NO FROM VW_INFO_OPNAME_SI WHERE TO_CHAR(OPN_ACT_DATE, 'DD/MM/YYYY') = '$_POST[tanggal]' AND OPN_TYPE = 'NON DRAWING' ";
    ...
    case "change_job":
        ...
        $subjobSql = "SELECT DISTINCT PROJECT_NAME, PROJECT_NAME_NEW "
                ...
                . "AND TO_CHAR(OPN_ACT_DATE, 'DD/MM/YYYY') = '$_POST[tanggal]'  AND OPN_TYPE = 'NON DRAWING' "
    ...
    case "change_subcont":
        ...
        $tanggal = $_POST['tanggal'];
        $sql = "SELECT DISTINCT OPNAME_ID, OPN_PERIOD, OPN_TYPE "
                . "FROM VW_INFO_OPNAME_SI "
                . "WHERE PROJECT_NO = '$job' "
                . "AND PROJECT_NAME = '$subjob' "
                . "AND TO_CHAR(OPN_ACT_DATE, 'DD/MM/YYYY') = '$_POST[tanggal]' AND OPN_TYPE = 'NON DRAWING' "
