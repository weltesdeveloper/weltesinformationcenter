...
<form class="form-horizontal" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-11">
            <select class="selectpicker" id="job" onchange="ChangeJob();" data-live-search="true" data-width="100%">
                ...
                <?php
                $jobSql = "SELECT DISTINCT PROJECT_NO FROM COMP_VW_INFO ORDER BY PROJECT_NO";
    ...
    <div class="form-group">
        <label class="control-label col-sm-1" for="pwd">REMARK</label>
        <div class="col-sm-11"> 
            <input type="text" class="form-control" id="remark-opname" placeholder="Contoh : Penambahan harga, Fabrikasi Ulang" value="">
        </div>
    </div>
</form>
...
<script>
    ...
    function ChangeJob() {
        ...
        $.ajax({
            type: 'POST',
            url: "special_drawing/drop_down_element.php",
    ...
    function ChangeSubcont() {
        ...
        $.ajax({
            type: 'POST',
            url: "special_drawing/change_subcont.php",
