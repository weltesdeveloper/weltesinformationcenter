...
<form class="form-horizontal" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-11"> 
            <input type="text" class="form-control" id="remark" placeholder="Digenerate Otomatis" value="" readonly="">
        </div>
    </div>
</form>
...
<script>
    ...
    function ChangeDate() {
        ...
        $.ajax({
            type: 'POST',
            url: "normal_drawing_revisi/drop_down_element.php",
    ...
    function ChangeSubcont() {
        ...
        $.ajax({
            ...
            success: function (response, textStatus, jqXHR) {
                ...
                $('#remark').val("NORMAL DRAWING");
                opname_id = response[0].OPNAME_ID;
            }
        }).then(function () {
            $.ajax({
                type: 'POST',
                url: "normal_drawing_revisi/show_opname_revision.php",
