...
<form class="form-horizontal" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-11"> 
            <input type="text" class="form-control" id="remark-opname" 
                   placeholder="Contoh : Penambahan harga, Fabrikasi Ulang" value="NORMAL DRAWING" readonly>
        </div>
    </div>
</form>
...
<script>
    ...
    function ChangeJob() {
        ...
        $.ajax({
            type: 'POST',
            url: "normal_drawing/drop_down_element.php",
    ...
    function ChangeSubcont() {
        ...
        $.ajax({
            type: 'POST',
            url: "normal_drawing/change_subcont.php",
