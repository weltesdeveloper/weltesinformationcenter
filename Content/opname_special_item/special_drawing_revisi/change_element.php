...
<form class="form-horizontal" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-11"> 
            <input type="text" class="form-control" id="remark" placeholder="Digenerate Otomatis" value="">
        </div>
    </div>
</form>
...
<script>
    ...
    function ChangeDate() {
        ...
        $.ajax({
            type: 'POST',
            url: "special_drawing_revisi/drop_down_element.php",
    ...
    function ChangeSubcont() {
        ...
        $.ajax({
            ...
            $.ajax({
                type: 'POST',
                url: "special_drawing_revisi/show_opname_revision.php",
