...
header("Content-Disposition: attachment; filename=Packing-List.xls");//ganti nama sesuai keperluan
...
<head>
	<meta charset="utf-8">
    <title>PT. WELTES ENERGI NUSANTARA | REPORT PACKING LIST</title>
...
<h4>Report Packing List <?php echo "<b>".$dt1->format('l, F d, Y')."</b> - <b>".$dt2->format('l, F d, Y')."</b>" ?></h4>
<div class="table-responsive">
	...
	<tbody>
		...
		$sqlPck = oci_parse($conn, "SELECT PCK.* FROM WELTESADMIN.MST_PACKING PCK WHERE $projectValSQL AND ACT_PACK_DATE BETWEEN TO_DATE('$DTAwal 00:00:01', 'MM/DD/YYYY HH24:MI:SS') AND TO_DATE('$DTAkhir 23:59:59', 'MM/DD/YYYY HH24:MI:SS') AND PCK_STAT = 'ACTIVE' ORDER BY SUBSTR(PCK.COLI_NUMBER, LENGTH(PCK.COLI_NUMBER)-4)");
		oci_execute($sqlPck);
