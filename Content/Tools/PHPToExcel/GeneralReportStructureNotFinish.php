    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><?php echo 'GENERAL INFORMATION REPORT STRUCTURE BUILDING : ' . $projectName; ?></h3>
            </div><!-- /.box-header -->
            <div>
                <table>
                    <tr>
                ...
                <table id="example1" border="1">
                    ...
                    <tbody>
                        ...
                        $generalInfoSql = "WITH XX "
                                ...
                                . "AND VDI.TYPE_BLD = 'STRUCTURE' "
                                . "AND VDI.ASSIGNED_QTY<>VDI.FAB_FINISHING "
...
//                        echo $generalInfoSql;
                        ...
                        while ($row = oci_fetch_array($generalInfoParse)) {
                            ...
                            <td style="vertical-align: middle; text-align:center">
                                <?php
                                $prosentase = 0;
                                $prosentase = $row['MARKING'] * $row['WEIGHT'] * 2 / 100 +
                                        $row['CUTTING'] * $row['WEIGHT'] * 3 / 100 +
                                        $row['ASSEMBLY'] * $row['WEIGHT'] * 25 / 100 +
