...
$objPHPExcel->setActiveSheetIndex(0)
        ->mergeCells('B6:T6')
        ->setCellValue('B6', 'ERECTION PROGRESS REPORT FOR NETT WEIGHT');
...
$componentSql = "SELECT MD.PROJECT_NAME,
                                ...
                                SUM (MD.TOTAL_QTY * MD.WEIGHT) TOTAL_WEIGHT,
...
header('Content-Disposition: attachment;filename="nettweight' . $jobName . '_' . $formattedDate . '.xls"');
