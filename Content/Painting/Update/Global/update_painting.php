...
EOD;
   ...
   // HAK AKSES
     $PAINT_ACCS       = 1;//HakAksesUser($username,'PAINT_ACCS',$conn);
     if ($PAINT_ACCS<>1) {
       # code...
        echo <<< EOD
  ...
  <div class="container">
    ...
    <div class="form-group" id="projectDropdown">
      <form class="form-inline" role="form"><br />
            <?php         
                $projectParse = oci_parse($conn, "SELECT DISTINCT (PROJECT_NAME) FROM PAINTING WHERE PAINT_STATUS = 'NOTCOMPLETE' ORDER BY PROJECT_NAME");
            ...
            echo '</SELECT>';
            ?>
            <input class="btn btn-success" type="button" accesskey="A" value="SHOW DATA & UPDATE" name="SHOW RECORD" id="show"/>
