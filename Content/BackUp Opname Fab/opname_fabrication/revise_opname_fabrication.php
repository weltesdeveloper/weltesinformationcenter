...
//RUBAH SUBCONT
            function ChangeSubcont() {
                ...
                $.ajax({
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "divpages_revision/show_opname_revision.php",
        ...
        <div class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="revise_opname_fabrication.php"><b>REVISE OPNAME</b></a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="input_opname_fabrication.php">INPUT</a></li>
                        <li class="active"><a href="revise_opname_fabrication.php">REVISE</a></li>
