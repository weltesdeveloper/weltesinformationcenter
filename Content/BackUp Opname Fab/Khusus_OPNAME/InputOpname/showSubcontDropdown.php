...
EOD;
     ...
     while(oci_fetch($uniqueCodeParse)){$uniqueCodeVal;}
     ...
     while(oci_fetch($uniqueProjectNameParse)){$uniqueProjectNameVal;}
?>
...
<?php
    ...
    echo '<SELECT name="subcontname" id="subcontSelectDropdown" class="selectpicker form-control"
...
<script>
    $(document).ready(function(){
        ...
        $('#subcontSelectDropdown').on('change', $(this), function () {
            var subcontVal = $('#subcontSelectDropdown').val();
            var periode = $('#periode').val();
            var date = $('#date').val();
            $.ajax({
                type: 'POST',
                url: "InputOpname/showFinalOpnameTable.php",
                data: {subcontValue : subcontVal, projectNameValue : '<?php echo $uniqueProjectNameVal ?>', jobValue:"<?php echo $jobVal;?>", periode:periode,date:date},
                success: function (response) {
                    $('#finalOpnameTable').html(response);
                }
            });
        });
    });
