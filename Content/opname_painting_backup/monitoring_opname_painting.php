...
<html lang="en">
    <head>
        ...
        <title>PT.WELTES ENERGI NUSANTARA | MONITORING OPNAME</title>
        <!-- Bootstrap -->
        ...
        <script>
            function ShowData() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "divpages_monitoring/show_monitoring_opname.php",
                    data: {periode: periode, type: type, job, subjob: subjob},
    ...
    <body>
        <div class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../../../../login_painting.php"><b>MONITORING OPNAME PAINTING</b></a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="../opname_painting_backup/input_opname_painting.php">INPUT DATA</a></li>
                        <li class="active"><a href="../opname_painting_backup/revise_opname_painting.php">REVISE</a></li>
                        <li><a  style="background-color: orange;" href="../opname_painting_backup/monitoring_opname_painting.php">MONITORING</a></li>
                    </ul>
        ...
        <div class="page-header text-center">
            <h1><font color="#0033CC"><b>MONITORING OPNAME PAINTING</b></font></h1>
        </div>
...
?>
        ...
        <div class="col-sm-12 pull-right" id="div-submit">
            <button class="btn btn-danger btn-sm pull-right" onclick="ShowData();" id="btn-submit">SHOW DATA</button>
        </div>
        <br><br>
