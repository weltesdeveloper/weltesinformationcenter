            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="../opname_painting_backup/input_opname_painting.php">INPUT DATA</a></li>
                        <li><a style="background-color: orange;" href="../opname_painting_backup/revise_opname_painting.php">REVISE</a></li>
