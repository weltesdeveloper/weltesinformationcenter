		...
		<section id="widget-grid" class="">
			...
			<div id="form" style="display:none" >
				...
				<div class="jarviswidget jarviswidget-color-teal" data-widget-editbutton="false">
					...
					<header>
						<h2>Form <strong>Product</strong> </h2>	
							...
							<form id="formInput" class="form-horizontal iconAfterControl" >
								...
								<fieldset>
									<div class="form-group">
										<label class="col-xs-1 col-lg-2 control-label">Kategori Product</label>
										<div class="col-xs-9 col-lg-6 selectContainer">
											<div class="input-group">
												<span class="input-group-addon">$</span>
												<select class="form-control" name="kat_product" id="kat_product">
												</select>
											</div>
										</div>
									</div>
								...
								<fieldset>
									<div class="form-group">
										<label class="col-xs-1 col-lg-2 control-label">Nama Product</label>
								...
								<fieldset>
									<div class="form-group">
										<label class="col-xs-1 col-lg-2 control-label">Gambar</label>
										<div class="col-xs-9 col-lg-6 inputGroupContainer">
											<div class="input-group">
...
<script src="pages/M-Product/script-product.js" type="text/javascript"></script>
