		...
		<section id="widget-grid" class="">
			...
			<div id="list">
				...
				<div class="jarviswidget jarviswidget-color-greenLight" data-widget-editbutton="false">
					...
					<header>
						<h2>List <strong>Pengumuman</strong></h2>						
					</header>
							...
							<div class="table-responsive">
							  <table class="table table-striped table-bordered table-condensed table-hover" id="tabelData">
								...
								<thead>
									...
									<tr>
										<th>ID </th>
										<th width="300">Judul Pengumuman</th>
										<th>Isi</th>
			...
			<div id="form" style="display:none" >
				...
				<div class="jarviswidget jarviswidget-color-teal" data-widget-editbutton="false">
					...
					<header>
						<h2>Form <strong>Pengumuman</strong> </h2>	
							...
							<form id="formInput" class="form-horizontal iconAfterControl" >
								...
								<fieldset>
									<div class="form-group">
										<label class="col-xs-1 col-lg-2 control-label">Judul Pengumuman</label>
										<div class="col-xs-9 col-lg-10 inputGroupContainer">
											<div class="input-group">
												<span class="input-group-addon">$</span>
												<input type="text" class="form-control" name="judulPeng" id="judulPeng"/>
											</div>
										</div>
									</div>
								</fieldset>
...
<script src="pages/M-Pengumuman/script-pengumuman.js" type="text/javascript"></script>
