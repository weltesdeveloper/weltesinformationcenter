$(document).ready(function() {
    $("#submit").click(function() {
        ...
        $.ajax({
            type: 'GET',
            dataType: 'json',
//            url: 'http://192.168.101.5:7777/weltesinformationcenter/Content/Fabrication/Update/Global/fabrication_image/API/model_index.php',
...
//                alert(json);
                if(json!=null){
                    alert('Login Success.');
                    window.location="pages/home/home.html?id1=" + json;
                }else{
                    alert('Login Failed ...!');
